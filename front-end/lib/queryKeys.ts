...
export const queryKeys = {
  ...
  students: {
    ...
    listPaginated: (search: string, filters?: Record<string, unknown>) => ['students', 'list', 'paginated', search, filters] as const,
  ...
  payments: {
    ...
    listPaginated: (filters?: Record<string, unknown>) => ['payments', 'list', 'paginated', filters] as const,
